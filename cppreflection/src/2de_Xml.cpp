...
namespace Deku2D
{
	...
	CXMLNode* CXMLChildrenList::First(const string &AValue /*= ""*/)
	{
		...
		{
			if (_stricmp((*it)->GetValue().c_str(), AValue.c_str()) == 0)
				return *it;
		}
	...
	{
		cout << "WARNING" <<  "This type of XML node doesn't support changing its value directly" ;
	}
	...
	{
		cout << "WARNING" <<  "This type of XML node doesn't support changing its name" ;
	}
	...
	{
		cout << "WARNING" <<  "This type of XML node doesn't support setting inner text" ;
	}
	...
	{
		cout << "WARNING" <<  "This type of XML node can't have any attributes" ;
		return "";
	}
	...
	{
		cout << "WARNING" <<  "You're trying to copy erronoues XML node" ;
		return this;
	}

	string CXMLErroneousNode::GetValue() const
	{
		cout << "WARNING" <<  "You're trying to get value of erronoues XML node" ;
		return "";
	}

	void CXMLErroneousNode::SetValue(const string &AValue)
	{
		cout << "WARNING" <<  "You're trying to set value of erronoues XML node" ;
	}

	string CXMLErroneousNode::GetName() const
	{
		cout << "WARNING" <<  "You're trying to get name of erronoues XML node" ;
		return "";
	}

	void CXMLErroneousNode::SetName(const string &AName)
	{
		cout << "WARNING" <<  "You're trying to set name of erronoues XML node" ;
	}

	string CXMLErroneousNode::GetText() const
	{
		cout << "WARNING" <<  "You're trying to get text of erroneous node" ;
		return "";
	}

	void CXMLErroneousNode::SetInnerText(const string &AText)
	{
		cout << "WARNING" <<  "You're trying to set inner text of erronoues XML node" ;
	}

	CXMLNode* CXMLErroneousNode::GetParent()
	{
		cout << "WARNING" <<  "You're trying to get parent of erronoues XML node" ;
		return this;
	}

	void CXMLErroneousNode::SetParent(CXMLNode *AParent)
	{
		cout << "WARNING" <<  "You're trying to set parent of erronoues XML node" ;
	}

	string CXMLErroneousNode::GetAttribute(const string &AName) const
	{
		cout << "WARNING" <<  "You're trying to get attribute of erronoues XML node" ;
		return "";
	}

	void CXMLErroneousNode::SetAttribute(const string &AName, const string &AValue)
	{
		cout << "WARNING" <<  "You're trying to set attribute of erronoues XML node" ;
	}

	void CXMLErroneousNode::DeleteAttribute(const string &AName)
	{
		cout << "WARNING" <<  "You're trying to delete attribute of erronoues XML node" ;
	}
	...
	string CXMLNodeWithAttributes::GetAttribute(const string &AName) const
	{
		...
		{
			cout << "WARNING" <<  "Attribute '%s' has not been found in XML node" <<  AName.c_str();
			return "";
		}
	...
	{
		cout << Severity.c_str() <<  string("XML parser: " + Message + " %d.").c_str() <<  Position;
